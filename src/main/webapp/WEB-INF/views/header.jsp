...
<nav class="navbar navbar-inverse" style="border-radius: 0 !important;">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="<c:url value="/home"/>" style="color:red;">Charity Date Auctions</a>
    </div>
    <ul class="nav navbar-nav">
      <!-- ADMIN menu -->
      <sec:authorize access="hasRole('ADMIN')">
      	<li><a href="<c:url value="/admin/addAuction"/>">Add Auction</a></li>
      </sec:authorize>
      <!-- USER menu -->
      <sec:authorize access="isAuthenticated()">
      	<li><a href="<c:url value="/user/allAuctions"/>">All Auctions</a></li>
      </sec:authorize>
    </ul>
